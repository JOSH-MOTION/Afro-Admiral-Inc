            ...
            <div className="max-w-7xl mx-auto px-6">
              <div className="grid grid-cols-3 gap-2 md:gap-4 text-center divide-x md:divide-x divide-brand-primary/10">
                ...
                <div className="py-3 md:py-0 px-2">
                  ...
                  <p className="mt-1 md:mt-2 text-[10px] md:text-sm font-semibold text-brand-darker uppercase tracking-wider leading-tight">Completed Projects</p>
                </div>
                {/* Stat 2 */}
                <div className="py-3 md:py-0 px-2">
                  <p className="text-3xl md:text-6xl font-extrabold text-brand-primary tracking-tight">
                  ...
                  <p className="mt-1 md:mt-2 text-[10px] md:text-sm font-semibold text-brand-darker uppercase tracking-wider leading-tight">Projects in Pipeline</p>
                </div>
                {/* Stat 3 */}
                <div className="py-3 md:py-0 px-2">
                  <p className="text-3xl md:text-6xl font-extrabold text-brand-primary tracking-tight">
                  ...
                  <p className="mt-1 md:mt-2 text-[10px] md:text-sm font-semibold text-brand-darker uppercase tracking-wider leading-tight">LPPs</p>
                </div>
              </div>
            </div>
          </section>
